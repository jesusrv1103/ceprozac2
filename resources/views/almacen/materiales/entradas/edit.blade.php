...
<div class="pull-left breadcrumb_admin clear_both">
  ...
  <div class="pull-right">
    <ol class="breadcrumb">
      ...
      <li><a style="color: #808080" href="{{url('/almacen/entradas/materiales')}}">Entradas de Almacén  Materiales/Refacciónes</a></li>
    </ol>
  </div> 
</div>
        ...
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Editar Entrada de Materiales Factura N°:{{$entrada->nota_venta}}</strong></h2>
            </div>
...
<div class="form-group">
  ...
  <div class="col-sm-3">
    <input name="nota" id="nota" value="{{$entrada->nota_venta}}"  type="text"  maxlength="10" onchange="mayus(this);"  class="form-control"  value="" placeholder="Ingrese el Número de Factura"/>
    ...
    while(i <= y){
      ...
      nombre=arregloDeSubCadenas[4];
        medida=arregloDeSubCadenas[5];
                ubicacionact=arregloDeSubCadenas[6];
      tecla=(document.all) ? event.keyCode : event.which;
