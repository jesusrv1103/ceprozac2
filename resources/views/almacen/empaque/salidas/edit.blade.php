...
<div class="pull-left breadcrumb_admin clear_both">
  ...
  <div class="pull-right">
    <ol class="breadcrumb">
      <li><a style="color: #808080" href="{{url('almacen/salidas/empaque')}}">Inicio</a></li>
      <li><a style="color: #808080" href="{{url('almacen/salidas/empaque')}}">Salidas de Almacén de Empaques</a></li>
    </ol>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="block-web">
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Editar Salida de Empaques: {{$material->nombre}} </strong></h2>
            </div>
        ...
        <form action="{{url('/almacen/salidas/empaque', [$salida->id])}}" method="post" class="form-horizontal row-border" parsley-validate novalidate files="true" enctype="multipart/form-data" accept-charset="UTF-8">
          {{csrf_field()}}
