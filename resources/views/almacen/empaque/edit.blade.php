...
<div class="pull-left breadcrumb_admin clear_both">
  ...
  <div class="pull-right">
    <ol class="breadcrumb">
      <li><a style="color: #808080" href="{{url('/almacen/empaque')}}">Inicio</a></li>
      <li><a style="color: #808080" href="{{url('/almacen/empaque')}}">Almacén de Empaque</a></li>
    </ol>
  </div>
</div>
        ...
        <div class="header">
          <div class="row" style="margin-top: 15px; margin-bottom: 12px;">
            <div class="col-sm-8">
              ...
              <h2 class="content-header" style="margin-top: -5px;"><strong>Editar Empaque: {{ $material->nombre}}</strong></h2> 
            </div>
            <div class="col-md-4">
 ...
 <input type="text" name="codigo" id="segundo"  value="{{$material->codigo }}" maxlength="12"   class="form-control" onkeypress=" return soloNumeros(event);" placeholder="Ingrese el Codigo de Barras" required value="" value="segundo"/><br>
   ...
   <td> <?php echo DNS1D::getBarcodeHTML("$material->id", "EAN13",3,33);?></td>
    ...
    <div class="form-group">
              ...
              <div class="col-sm-6">
                <input name="descripcion" value="{{$material->descripcion}}" type="text"  onchange="mayus(this);"  class="form-control"  value="" placeholder="Ingrese Descripción del Material" />
              </div>
            </div>
